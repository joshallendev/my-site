        ...
        <div class="flex flex-wrap -m-4">
          <div class="p-4 md:w-1/2">
            <div class="h-full flex flex-col items-center text-center">
              ...
              <div class="w-full">
                <span class="title-font font-medium text-lg border-b-4 border-pink border-solid">PROJECT 1</span>
          ...
          <div class="p-4 md:w-1/2">
            <div class="h-full flex flex-col items-center text-center">
              ...
              <div class="w-full">
                <span class="title-font font-medium text-lg border-b-4 border-pink border-solid">PROJECT 2</span>
                <p class="mb-4">DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
              </div>
            </div>
          </div>
          <div class="p-4 md:w-1/2">
            <div class="h-full flex flex-col items-center text-center">
              ...
              <div class="w-full">
                <span class="title-font font-medium text-lg border-b-4 border-pink border-solid">PROJECT 3</span>
                <p class="mb-4">DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
              </div>
            </div>
          </div>
          <div class="p-4 md:w-1/2">
            <div class="h-full flex flex-col items-center text-center">
              ...
              <div class="w-full">
                <span class="title-font font-medium text-lg border-b-4 border-pink border-solid">PROJECT 4</span>
                <p class="mb-4">DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
              </div>
            </div>
          </div>
